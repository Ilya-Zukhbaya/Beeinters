  ...
  const secItems = [
    {
      ...
      href: '',
      onClick: () => {
        setMentorModalActive(true);
      },
      class: 'menu-li',
    },
    { value: 'Лекции:', href: '', class: 'menu-li' },
    {
      value: 'HTML/CSS',
      href: 'lectures-html-css',
      icon: './pictures/leftbar/1Shape.png',
      onClick: () => {
        setLeftMenu(false);
      },
      class: 'left-li-menu',
    },
    {
      value: 'GIT',
      href: 'lectures-git',
      icon: './pictures/leftbar/2Shape.png',
      onClick: () => {
        setLeftMenu(false);
      },
      class: 'left-li-menu',
    },
    {
      value: 'JavaScript',
      href: 'lectures-js',
      icon: './pictures/leftbar/3Shape.png',
      onClick: () => {
        setLeftMenu(false);
      },
      class: 'left-li-menu',
    },
    {
      value: 'React',
      href: 'lectures-react',
      icon: './pictures/leftbar/4Shape.png',
      onClick: () => {
        setLeftMenu(false);
      },
      class: 'left-li-menu',
    ...
    {
      value: 'Angular',
      href: 'lectures-angular',
      icon: './pictures/leftbar/5Shape.png',
      onClick: () => {
        setLeftMenu(false);
      },
      class: 'left-li-menu',
    },
    {
      value: 'Data',
      href: 'lectures-data',
      icon: './pictures/leftbar/6Shape.png',
      onClick: () => {
        setLeftMenu(false);
      },
      class: 'left-li-menu',
  ...
  return (
    <div className="topbar-container">
      ...
      <nav className="nav-container">
        <div className="leftbar__burger-btn" onClick={() => setLeftMenu(!leftMenu)}>
          <button>
            <img
      ...
      <LeftMenu header={'Left-Menu'} items={secItems} active={leftMenu} setActive={setLeftMenu} />
    </div>
  );
};
